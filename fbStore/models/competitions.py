...
class Tournaments:
    ...
    associated_league = models.ForeignKey("fbStore.competitions.League", related_name="tournament", null=True,
                                             on_delete=models.SET_NULL, help_text= "Associated league.")
    associated_country = models.ForeignKey("fbStore.environment.Country", related_name="tournament", null=True,
                                             on_delete=models.SET_NULL, help_text= "Associated country.")
    associated_org = models.ForeignKey("fbStore.world.FootballAssociation", related_name="tournament", null=True,
...
class Leagues:
    ...
    associated_country = models.ForeignKey("fbStore.environment.Country", related_name="league", null=True,
                                             on_delete=models.SET_NULL, help_text= "Associated country.")